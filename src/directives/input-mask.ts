 ...
 * ====================================================
 *
 * Created by anele on 2019/07/09.
 *
 * ====================================================
 */
...
export class BrMaskerIonic implements OnInit, ControlValueAccessor {
    ...
    private phoneMask(v: any): void {
        ...
        if (n.length > 14) {
            ...
            this.brmasker.mask = '(999) 999-9999';
            n = n.replace(/\D/gi, '');
            n = n.replace(/(\d{2})(\d)/gi, '$1 $2');
            n = n.replace(/(\d{4})(\d)/gi, '$1-$2');
            n = n.replace(/(\d{4})(\d)/gi, '$1$2');
